...
public class FuncImageButton extends RelativeLayout {
	...
	public FuncImageButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		longPressable = false;
		LayoutInflater.from(context).inflate(R.layout.func_imagebutton, this,
				true);
